...
caminho_cidade = os.path.join(caminho, arquivos["Supermercados Cidade"])
...
caminho_dupovo = os.path.join(caminho, arquivos["Rede Dupovo"])
caminho_levate = os.path.join(caminho, arquivos["Levate"])
caminho_pagpouco = os.path.join(caminho, arquivos["Smart Pagpouco"])
caminho_pejoal = os.path.join(caminho, arquivos["Supervarejista Pejoal"])
caminho_reidoarroz = os.path.join(caminho, arquivos["Rei do Arroz"])
caminho_rena = os.path.join(caminho, arquivos["Rena"])
caminho_escola = os.path.join(caminho, arquivos["Supermercado Escola"])
caminho_superminas = os.path.join(caminho, arquivos["Superminas"])
caminho_vidal = os.path.join(caminho, arquivos["Supermercado Vidal"])

# CRIANDO VARIÁVEIS DOS RELATÓRIOS

relatorios = {
    "Badiao": pd.read_excel(caminho_badiao, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
    ...
    "Supermercados Cidade": pd.read_excel(caminho_cidade, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
    ...
    "Rede Dupovo": pd.read_excel(caminho_dupovo, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
    "Levate": pd.read_excel(caminho_levate, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
    "Smart Pagpouco": pd.read_excel(caminho_pagpouco, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
    "Supervarejista Pejoal": pd.read_excel(caminho_pejoal, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
    ...
    "Supermercado Escola": pd.read_excel(caminho_escola, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
    "Superminas": pd.read_excel(caminho_superminas, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
    "Supermercado Vidal": pd.read_excel(caminho_vidal, sheet_name="Formato Arquivo", header=3, dtype={"CNPJ": str, "CODPROD": str}),
}
